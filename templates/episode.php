        ...
        <div class="left-content" style="padding-left: 10px;padding-right: 10px;">
            ...
            phim</span>
                ...
                <div class="button-watch  btn-report">
                    <span><i class="fa fa-eye" aria-hidden="true"></i> <?= op_get_post_view() ?> Lượt xem </span>
                </div>
                ...
                <div class="list-server" id="list-server">
                    <div class="server-item">
                        ...
                        <span onclick="chooseStreamingServer(this)" data-type="m3u8"
                        ...
                        <span onclick="chooseStreamingServer(this)" data-type="embed"
                ...
                <div class="details">
                                ...
                                <li class="list-item" style="padding: 0;">
                                    ...
                                    <div class="col-xs-12 col-sm-10 p-a-0 ">
                                        <a href="<?php the_permalink(); ?>" class="text-primary">
                                            <h1 class="film-title text-uppercase" style="margin-bottom: 0"><?php the_title(); ?>
                                            </h1>
                                        </a>
                                        <h2 class="text-muted film-title" style="color: #B3B3B3;"><?= op_get_original_title() ?>
                                            (<?= op_get_year() ?>)</h2>
                                        <div class="p-2">
                                            <div class="tags-info"
                                           ...
                                           <?= op_get_regions() ?>
                                            ...
                                            <?= op_get_year() ?>
                                                ...
                                                <span
                                                        class="tags-item-info"><?= op_get_total_episode() ?></span>
                                            </div>
                                        </div>
                        ...
                        <div class="box-rating">
                            ...
                            <span class="average" id="average" itemprop="ratingValue">
                                <?= op_get_rating() ?>
                                    ...
                                    <span id="rate_count" itemprop="reviewCount"><?= op_get_rating_count() ?></span> lượt
                                    đánh giá
                                </div>
                                <span id="hint"></span>
                    ...
                    <div class="control-box clear">
                        ...
                        <div class="episodes" style="padding: 5px 2px;margin: 5px 0 10px 0;">
                            ...
                            <i class="fa fa-youtube-play"></i> DANH SÁCH TẬP: <?= $server['server_name'] ?><i class="fa fa-angle-down"></i> </span>
                            </div>
                        ...
                        if ($taxonomy) {
                            ...
                            if ($my_query->have_posts()):
                                while ($my_query->have_posts()):$my_query->the_post(); ?>
                                    <?php include THEME_URL . '/templates/section/block_thumb_item.php' ?>
                                <?php
                                endwhile;
                            endif;
                            wp_reset_query();
