...
class WG_oPhim_Categories extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <?php if ($query->have_posts()) : ?>
            <?php
                if($style == 4 ){
                    include THEME_URL.'/templates/section/block_slider.php';
                }
                if($style == 5 ){
                    include THEME_URL.'/templates/section/block_thumb.php';
                }
                if($style == 6 ){
                    include THEME_URL.'/templates/section/block.php';
                }
            ?>
        <?php endif; ?>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <br>
            <?php
            $f = array( '4' => __('Slide', 'ophim'), '5' => __('Thumb', 'ophim'), '6' => __('Slide Poster', 'ophim'));
            foreach ($f as $x => $n ) { ?>
